...
exports.remindCompetition = catchAsyncErrors(async (user, competitionDetails) => {
...
exports.notifyCompetitionJoined = catchAsyncErrors(async (user, competitionDetails) => {
...
exports.notifyWalletUpdate = catchAsyncErrors(async (user, coinReward) => {
    const message = `Your wallet has been updated with ${coinReward} Picoins!`;
...
exports.sendModerationWarning = catchAsyncErrors(async (user, warningMessage) => {
